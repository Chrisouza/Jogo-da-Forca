...
doze_letras = [
    ...
    "concomitante", "convergência", "cordialidade", "conhecimento",
...
treze_letras = [
    ...
    "quintessência", "inconsequente", "sobressalente",
...
quatorze_letras = [
    ...
    "superveniência", "bem-aventurado", "atenciosamente", "transcendência",
    ...
    "espontaneidade", "funcionalidade", "intransigência",
    ...
    "aleatoriamente", "impressionante", "questionamento", "implicitamente",
